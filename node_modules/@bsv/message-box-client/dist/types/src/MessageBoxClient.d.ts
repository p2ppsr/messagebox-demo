...
import { SetMessageBoxPermissionParams, GetMessageBoxPermissionParams, MessageBoxPermission, MessageBoxMultiQuote, MessageBoxQuote, ListPermissionsParams, GetQuoteParams, SendListParams, SendListResult } from './types/permissions.js';
/**
...
export declare class MessageBoxClient {
   ...
   */
    sendMesagetoRecepients(params: SendListParams, overrideHost?: string): Promise<SendListResult>;
    /**
     * @method anointHost
     * @async
     ...
     * })
     */
    getMessageBoxQuote(params: GetQuoteParams, overrideHost?: string): Promise<MessageBoxQuote | MessageBoxMultiQuote>;
    /**
     ...
     */
    sendNotification(recipient: PubKeyHex | PubKeyHex[], body: string | object, overrideHost?: string): Promise<SendMessageResponse | SendListResult>;
    /**
    ...
    */
    ...
    private createMessagePaymentBatch;
}
