 ...
 */
import { WalletClient, AuthFetch, LookupResolver, TopicBroadcaster, Utils, Transaction, PushDrop, P2PKH, PublicKey, ProtoWallet, Random, Beef, } from '@bsv/sdk';
            ...
            try {
                if (p.messageContent != null &&
                    ...
                    const decrypted = await this.walletClient.decrypt({
                        ...
                        ciphertext: Utils.toArray((p.messageContent).encryptedMessage, 'base64')
                    }, this.originator);
