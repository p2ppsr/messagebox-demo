...
import { Peer, Utils } from '@bsv/sdk';
 ...
 */
export function AuthSocketClient(url, opts) {
    ...
    // 3) Create a Peer
    const peer = new Peer(opts.wallet, transport, opts.requestedCertificates, opts.sessionManager, undefined, opts.originator);
