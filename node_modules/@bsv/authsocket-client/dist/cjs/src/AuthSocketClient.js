...
class AuthSocketClientImpl {
    ...
    constructor(ioSocket, peer) {
        ...
        this.ioSocket.on('connect', () => {
            var _a;
            this.connected = true;
            this.id = (_a = this.ioSocket.id) !== null && _a !== void 0 ? _a : '';
...
function AuthSocketClient(url, opts) {
    ...
    // 3) Create a Peer
    const peer = new sdk_1.Peer(opts.wallet, transport, opts.requestedCertificates, opts.sessionManager, undefined, opts.originator);
