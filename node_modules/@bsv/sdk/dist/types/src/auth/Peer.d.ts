...
export declare class Peer {
    ...
    private readonly certificateValidationPromises;
     ...
     */
    toPeer(message: number[], identityKey?: string): Promise<void>;
    /**
     ...
     */
    requestCertificates(certificatesToRequest: RequestedCertificateSet, identityKey?: string): Promise<void>;
    /**
     ...
     */
    getAuthenticatedSession(identityKey?: string): Promise<PeerSession>;
    /**
     ...
     */
    private resolveCertificateValidation;
    private getIdentityPublicKey;
    private static utf8ToBytes;
