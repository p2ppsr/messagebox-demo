        ...
        if (isScriptExecuting && currentOpcode >= 0 && currentOpcode <= OP_js_1.default.OP_PUSHDATA4) {
            ...
            switch (currentOpcode) {
                ...
                case OP_js_1.default.OP_NOP10:
                    break;
                case OP_js_1.default.OP_VERIF:
                case OP_js_1.default.OP_VERNOTIF:
                    fValue = false;
                    if (isScriptExecuting) {
                        ...
                        if (currentOpcode === OP_js_1.default.OP_VERNOTIF)
                            fValue = !fValue;
                    }
                ...
                case OP_js_1.default.OP_RSHIFT: {
                    ...
                    if (currentOpcode === OP_js_1.default.OP_LSHIFT) {
                        ...
                        const mask = new BigNumber_js_1.default(1).ushln(buf1.length * 8).isubn(1);
                ...
                case OP_js_1.default.OP_2MUL:
                case OP_js_1.default.OP_2DIV:
                ...
                case OP_js_1.default.OP_0NOTEQUAL:
                    ...
                    switch (currentOpcode) {
                        ...
                        case OP_js_1.default.OP_1SUB:
                            ...
                            break;
                        case OP_js_1.default.OP_2MUL:
                            bn = bn.mul(new BigNumber_js_1.default(2));
                            break;
                        case OP_js_1.default.OP_2DIV:
                            bn = bn.div(new BigNumber_js_1.default(2));
                            break;
                        case OP_js_1.default.OP_NEGATE:
                            bn = bn.neg();
                            break;
                        ...
                        case OP_js_1.default.OP_NOT:
                            ...
                            break;
                        case OP_js_1.default.OP_0NOTEQUAL:
                            bn = new BigNumber_js_1.default(bn.cmpn(0) === 0 ? 0 : 1);
                            break;
                    }
                ...
                case OP_js_1.default.OP_MAX: {
                    ...
                    switch (currentOpcode) {
                        ...
                        case OP_js_1.default.OP_NUMEQUALVERIFY:
                            ...
                            break;
                        case OP_js_1.default.OP_NUMNOTEQUAL:
                            resultBnArithmetic = new BigNumber_js_1.default(bn1.cmp(bn2) === 0 ? 0 : 1);
                            break;
                        case OP_js_1.default.OP_LESSTHAN:
                            resultBnArithmetic = new BigNumber_js_1.default(bn1.cmp(bn2) < 0 ? 1 : 0);
                            break;
