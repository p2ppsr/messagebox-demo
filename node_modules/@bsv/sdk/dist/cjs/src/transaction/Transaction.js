...
const LivePolicy_js_1 = __importDefault(require("./fee-models/LivePolicy.js"));
...
class Transaction {
     ...
     */
    static fromEF(ef) {
        const br = utils_js_1.ReaderUint8Array.makeReader(ef);
    ...
    static parseScriptOffsets(bin) {
        const br = utils_js_1.ReaderUint8Array.makeReader(bin);
        const inputs = [];
        const outputs = [];
        br.pos += 4; // version
        const inputsLength = br.readVarIntNum();
    ...
    static fromBinary(bin) {
        ...
        const br = new utils_js_1.ReaderUint8Array(rawBytes);
     ...
     */
    static fromHex(hex) {
        const rawBytes = (0, utils_js_1.toUint8Array)(hex, 'hex');
        const br = new utils_js_1.ReaderUint8Array(rawBytes);
        const tx = Transaction.fromReader(br);
        tx.rawBytesCache = rawBytes;
        tx.hexCache = (0, utils_js_1.toHex)(rawBytes);
        return tx;
    }
    /**
    ...
    static fromHexEF(hex) {
        return Transaction.fromEF((0, utils_js_1.toUint8Array)(hex, 'hex'));
    }
    /**
     ...
     *
     */
    async fee(modelOrFee = LivePolicy_js_1.default.getInstance(), changeDistribution = 'equal') {
        this.invalidateSerializationCaches();
     ...
     */
    toHexEF() {
        return (0, utils_js_1.toHex)(this.toEFUint8Array());
    }
    /**
    ...
    toHex() {
        ...
        const hex = (0, utils_js_1.toHex)(bytes);
        this.hexCache = hex;
        return hex;
    }
    /**
    ...
    hash(enc) {
        if (this.cachedHash == null) {
            this.cachedHash = (0, Hash_js_1.hash256)(this.getSerializedBytes());
        }
        if (enc === 'hex') {
            return (0, utils_js_1.toHex)(this.cachedHash);
        }
    ...
    async completeWithWallet(wallet, actionDescription, originator, options) {
        ...
        const beefData = new Beef_js_1.Beef();
    ...
    preimage(inputIndex, signatureScope, subscript) {
        ...
        signatureScope ?? (signatureScope = TransactionSignature_js_1.default.SIGHASH_FORKID | TransactionSignature_js_1.default.SIGHASH_ALL);
