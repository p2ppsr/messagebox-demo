...
const ReaderUint8Array_js_1 = require("../primitives/ReaderUint8Array.js");
/**
...
class MerklePath {
    ...
    static fromBinary(bump) {
        const reader = new ReaderUint8Array_js_1.ReaderUint8Array(bump);
     ...
     */
    toHex() {
        return (0, utils_js_1.toHex)(this.toBinaryUint8Array());
    }
    //
    indexOf(txid) {
    ...
    findOrComputeLeaf(height, offset) {
        const hash = (m) => (0, utils_js_1.toHex)((0, Hash_js_1.hash256)((0, utils_js_1.toArray)(m, 'hex').reverse()).reverse());
        let leaf = height < this.path.length
